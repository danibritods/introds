...
![Processo da ciência de dados](Imagens/DS_Process.png)
...
if (is_using_dense_data) {
  base_path <- paste0(base_path, "Compact")
}
...
![Gráfico 1](Imagens/meu_grafico_1.png)
...
![Gráfico 2](Imagens/meu_grafico_10-por_dia.png)
...
![Gráfico 3](Imagens/meu_grafico_15.png)
...
![Gráfico 4](Imagens/meu_grafico_28.png)
...
![Gráfico 5](Imagens/meu_grafico_44.png)
...
![Falas do Bolsonaro](https://i0.wp.com/cartacampinas.com.br/wordpress/wp-content/uploads/falas-de-bolsonaro-e-gra%C2%B4fico-da-covid-19-coronav%C3%ADrus.jpg)
