...
> Datasets tidys são todos iguais, mas datasets bagunçados são cada um bagunçados do seu próprio jeito. 
...
- Se quisermos a taxa de tuberculose a cada 10,000 habitantes:
